...
class MGNet(nn.Module):
    def __init__(self, params):
        ...
        self.up4 = DeconvLayer(self.ft_chns[1], self.ft_chns[0], kernel_size=2,
                               dim=2, stride=2, groups=self.ft_groups[0],
                               acti_func=get_acti_func(self.acti_func, self.params))
...
class GMGNet(nn.Module):
    def __init__(self, params):
        super(GMGNet, self).__init__()
        self.params = params
        self.in_chns = self.params['in_chns']
        self.ft_chns = self.params['feature_chns']
        self.ft_groups = self.params['feature_grps']
...
if __name__ == '__main__':
    ...
    print(torchsummary.summary(net, input_size=(1, 192, 192)))

    # from model.Unet import UNetWithFeature
    #
    # net = UNetWithFeature(1, 4, num_filter=16).cuda()
    # print(torchsummary.summary(net, input_size=(1, 192, 192)))
